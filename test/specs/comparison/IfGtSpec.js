(function( root, factory ) {
    ...
    // Next for Node.js or CommonJS.
        ...
        require( '../../../src/comparison/if-gt' )( Handlebars );
    ...
    describe('If Greater Than Handlebars Helper', function () {
        ...
        it("should return undefined if values arent greater than and no inverse function is specified when complied as a template", function () {
            var template = Handlebars.compile( '{{#if-gt 0 1}}main branch{{/if-gt}}' );
